...
If you're interested in running the animated Voronoi, you will also need to 
install ImageMagick from https://imagemagick.org/script/download.php. This is 
a widely used image manipulation library.
...
More experiments with Voronoi here - https://github.com/thecomeonman/MakingFriendsWithTrackingData
